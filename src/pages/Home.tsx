      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            ...
            >
              Descubre una experiencia web única y atractiva
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {[
            {
              ...
              description: 'Experiencia de usuario fluida y atractiva con animaciones suaves.',
            ...
            },
            {
              ...
              image: 'https://images.unsplash.com/photo-1526925539332-aa3b66e35444?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80'
            },
            {
              title: 'Moderno',
              description: 'Utilizando las últimas tecnologías web para mejor rendimiento.',
